        ...
        <div className="navbar__contact-main ">
          <div className="container navbar__contact ">
            <div className="navbar__contact-left">
              <a href="tel:+998787778484" className="conatact__number">
              ...
              <a
                href="mailto:info@online-mahalla.uz"
            ...
            <div className="navbar__socail-media">
              <a href="https://t.me/onlinemahalla" target={"_blank"}>
                <img src={TelegramIcon} />
              </a>
              <a
                href="https://www.instagram.com/onlinemahalla/"
                target={"_blank"}
              >
          ...
          <div className="container">
            ...
            <div className="bar__menu-all ">
              <ul className="bar__nav-items">
                ...
                <li>
                  <Link to="/about">Тизим ҳақида</Link>
                </li>
                <li>
                  <a href="#news" onClick={() => navigate("/#news")}>
                    Онлайн ахборотнома
                  </a>
                </li>
                <li>
